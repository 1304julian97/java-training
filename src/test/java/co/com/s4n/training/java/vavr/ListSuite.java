...
public class ListSuite {
    ...
    public void testListOfNull() {
        assertThrows(java.lang.NullPointerException.class,()-> List.of(null));
    }
    ...
    public void testHeadDeUnaListaVacia(){
        ...
        assertThrows(java.util.NoSuchElementException.class, ()->lista.head());
    }
    ...
    {
        assertThrows(NoSuchElementException.class,()->List.of().pop2());
